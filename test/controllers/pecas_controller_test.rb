...
class PecasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peca" do
    assert_difference("Peca.count") do
      post pecas_url, params: { peca: { nome: @peca.nome, preco: @peca.preco, quantidade: @peca.quantidade } }
    end
  ...
  test "should update peca" do
    patch peca_url(@peca), params: { peca: { nome: @peca.nome, preco: @peca.preco, quantidade: @peca.quantidade } }
